...
DECISIONS = 12  #The length of the word we are generating. If we are generating a graph, we create a 0-1 word of length (N choose 2)
GENERATIONS = 10000
...
for i in range(GENERATIONS): #1000000 generations should be plenty
